...
{
    [self tryToSendTextMessage:@"I have captured a screenshot of this conversation" updateKeyboardState:NO];
}
...
- (void)updateGroupModelTo:(TSGroupModel *)newGroupModel extraGroupRecipients:(NSArray<SignalServiceAddress *> *)extraGroupRecipients successCompletion:(void (^_Nullable)(void))successCompletion
{
...
- (void)groupWasUpdated:(TSGroupModel *)groupModel extraGroupRecipients:(NSArray<SignalServiceAddress *> *)extraGroupRecipients
{
    ...
    [self updateGroupModelTo:groupModel extraGroupRecipients:extraGroupRecipients successCompletion:nil];
}
