    ...
    for (SignalServiceAddress *address in sortedAddresses) {
        [section addItem:[OWSTableItem
                             itemWithCustomCellBlock:^{
                                 ...
                                 } else if ([self.thread isRemoteAddressGroupOwner:address]) {
                                     cell.accessoryMessage = @"Owner";
                                 } else if ([self.thread isRemoteAddressGroupAdmin:address]) {
                                     cell.accessoryMessage = @"Admin";
                                 }
