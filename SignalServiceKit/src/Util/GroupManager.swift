...
public class GroupManager: NSObject {
    ...
    private static func buildGroupModel(groupId groupIdParam: Data?,
                                        ...
                                        avatarData: Data?,
                                        owner ownerParam: SignalServiceAddress?,
                                        admins adminsParam: [SignalServiceAddress]?,
        ...
        return TSGroupModel(groupId: groupId, name: name, avatarData: avatarData, members: members, owner: ownerParam, admins: adminsParam ?? [], groupsVersion: groupsVersion)
    }
    ...
    public static func createGroup(members: [SignalServiceAddress],
                                   groupId: Data? = nil,
                                   name: String? = nil,
                                   owner: SignalServiceAddress? = nil,
    ...
    public static func createGroup(members: [SignalServiceAddress],
        ...
        return DispatchQueue.global().async(.promise) {
            let model = try buildGroupModel(groupId: groupId, name: name, members: members, avatarData: avatarData, owner: owner, admins: admins)
    ...
    public static func createGroupForTests(transaction: SDSAnyWriteTransaction,
        ...
        let model = try buildGroupModel(groupId: groupId, name: name, members: members, avatarData: avatarData, owner: owner, admins: admins, groupsVersion: groupsVersion)
