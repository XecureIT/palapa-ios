...
@property (nullable, nonatomic) SignalServiceAddress *groupOwner;
@property (nonatomic) NSArray<SignalServiceAddress *> *groupAdmins;
...
- (instancetype)initWithGroupId:(NSData *)groupId
                     ...
                     avatarData:(nullable NSData *)avatarData
                        members:(NSArray<SignalServiceAddress *> *)members
                          owner:(nullable SignalServiceAddress *)owner
                         admins:(NSArray<SignalServiceAddress *> *)admins
