...
#define kLegalTermsUrlString @"https://landing.xecure.world/privacy-policy.html"
...
#define textSecureProfileAvatarAPI @"v1/profile/avatar"
#define textSecure2FAAPI @"v1/accounts/pin"
#define textSecureRegistrationLockV2API @"v1/accounts/registration_lock"

#define SignalApplicationGroup @"group.id.xecureworld.palapa"
